<?php
session_start(); 
include '../db_connection.php'; // koneksi database, pastikan ini sudah benar
...
$perluDikirim = getCountStatus($conn, 'dikirim'); // misal status untuk perlu dikirim
$pembatalan = getCountStatus($conn, 'dibatalkan');
$pengembalian = getCountStatus($conn, 'pengembalian'); // pastikan ada status ini di DB
$ulasanPerluDibalas = getCountStatus($conn, 'ulasan_perlu_dibalas'); // custom status, sesuaikan
?>
  ...
  <main class="flex min-h-[calc(100vh-144px)]">
   ...
   <aside class="bg-gray-100 w-64 p-6 flex flex-col space-y-8 text-gray-700 text-sm select-none">
    ...
    <div class="flex flex-col space-y-2">
     ...
     <a class="text-gray-500 text-sm hover:underline" href="#">
      Profile
     </a>
     <a class="text-gray-500 text-sm hover:underline" href="#">
      Alamat
    ...
    <p class="font-bold text-gray-700 text-sm cursor-pointer select-none">
     Produk
    </p>
    <p class="font-bold text-gray-700 text-sm cursor-pointer select-none">
     Notifikasi
  ...
  <div class="flex flex-col items-center space-y-1 cursor-pointer">
    ...
    <div class="bg-gray-600 rounded-md p-6 flex justify-between max-w-full text-gray-300">
     <div class="flex flex-col items-center space-y-1">
      ...
      <p class="font-bold text-xs text-gray-300">
       Produk
      </p>
     </div>
     <div class="flex flex-col items-center space-y-1">
